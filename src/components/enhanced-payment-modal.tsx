...
import { X, DollarSign, CreditCard, Calendar, FileText, Upload, Camera, Receipt, AlertCircle, CheckCircle } from "lucide-react"
...
export default function EnhancedPaymentModal({ isOpen, onClose, fee, onSuccess }: EnhancedPaymentModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (uploadedFiles.length > 0) {
        receiptUrls = await uploadFiles(uploadedFiles)
      }
