...
import { TodoPriority, StudentJourneyStage } from '../src/generated/prisma/client'
...
const TODO_TEMPLATES = [
  // INITIAL_ENQUIRY STAGE
  {
    ...
    estimatedDays: 7,
    isRequired: true,
    targetStage: "INITIAL_ENQUIRY" as StudentJourneyStage,
  ...
  // DOCUMENTATION STAGE
  {
    ...
    estimatedDays: 5,
    isRequired: true,
    targetStage: "DOCUMENTATION" as StudentJourneyStage,
  ...
  // APPLICATION SUBMITTED STAGE
  {
    ...
    estimatedDays: 3,
    isRequired: true,
    targetStage: "APPLICATION_SUBMITTED" as StudentJourneyStage,
    categoryName: "Application Process",
    checklistItems: [
  ...
  // APPLICATION PROCESSING STAGE
  {
    ...
    estimatedDays: 60,
    isRequired: true,
    targetStage: "APPLICATION_PROCESSING" as StudentJourneyStage,
    categoryName: "Application Process",
    checklistItems: [
  ...
  // OFFER RECEIVED STAGE
  {
    ...
    estimatedDays: 5,
    isRequired: true,
    targetStage: "OFFER_RECEIVED" as StudentJourneyStage,
    categoryName: "Application Process",
    checklistItems: [
  ...
  // ACCEPTANCE CONFIRMED STAGE
  {
    ...
    estimatedDays: 3,
    isRequired: true,
    targetStage: "ACCEPTANCE_CONFIRMED" as StudentJourneyStage,
    categoryName: "Financial",
    checklistItems: [
  ...
  // VISA APPLICATION STAGE
  {
    ...
    estimatedDays: 7,
    isRequired: true,
    targetStage: "VISA_APPLICATION" as StudentJourneyStage,
    categoryName: "Financial",
    checklistItems: [
  ...
  // VISA PROCESSING STAGE
  {
    ...
    estimatedDays: 45,
    isRequired: true,
    targetStage: "VISA_PROCESSING" as StudentJourneyStage,
    categoryName: "Visa & Immigration",
    checklistItems: [
  ...
  // VISA APPROVED STAGE
  {
    ...
    estimatedDays: 3,
    isRequired: true,
    targetStage: "VISA_APPROVED" as StudentJourneyStage,
    categoryName: "Visa & Immigration",
    checklistItems: [
  ...
  // PRE-DEPARTURE STAGE
  {
    ...
    estimatedDays: 7,
    isRequired: true,
    targetStage: "PRE_DEPARTURE" as StudentJourneyStage,
  ...
  // FLIGHT BOOKING STAGE
  {
    ...
    estimatedDays: 3,
    isRequired: true,
    targetStage: "FLIGHT_BOOKING" as StudentJourneyStage,
    categoryName: "Travel & Accommodation",
    checklistItems: [
  ...
  // ACCOMMODATION SETUP STAGE
  {
    ...
    estimatedDays: 5,
    isRequired: true,
    targetStage: "ACCOMMODATION_SETUP" as StudentJourneyStage,
    categoryName: "Travel & Accommodation",
    checklistItems: [
  ...
  // PACKING PREPARATION STAGE
  {
    ...
    estimatedDays: 3,
    isRequired: true,
    targetStage: "PACKING_PREPARATION" as StudentJourneyStage,
  ...
  // DEPARTURE STAGE
  {
    ...
    estimatedDays: 1,
    isRequired: true,
    targetStage: "DEPARTURE" as StudentJourneyStage,
    categoryName: "Travel & Accommodation",
    checklistItems: [
  ...
  // POST_ARRIVAL STAGE
  {
    ...
    estimatedDays: 1,
    isRequired: true,
    targetStage: "POST_ARRIVAL" as StudentJourneyStage,
    categoryName: "Visa & Immigration",
    checklistItems: [
...
async function seedTodoTemplates() {
  console.log("🌱 Starting to seed todo templates...")

  try {
    // Get the first consultancy (or create a default one)
    ...
    for (const templateData of TODO_TEMPLATES) {
      ...
      const template = await prisma.todoTemplate.create({
        data: {
          ...
          targetStage: templateData.targetStage,
          isActive: true
        }
      })
    ...
    console.log("🎉 Todo templates seeded successfully!")
    
    // Print summary
    const totalCategories = await prisma.todoCategory.count({ where: { consultancyId: consultancy.id } })
    const totalTemplates = await prisma.todoTemplate.count({ where: { consultancyId: consultancy.id } })
    ...
    console.error("❌ Error seeding todo templates:", error)
    throw error
  } finally {
