...
async function main() {
  ...
  const admin = await prisma.user.upsert({
    where: { email: 'prem@fate.edu.np' },
    update: {},
    create: {
      email: 'prem@fate.edu.np',
      name: 'Prem',
      password: await bcrypt.hash('hed0nist', 10),
      role: 'ADMIN',
  ...
  console.log('Admin: prem@fate.edu.np / hed0nist')
  console.log('Counselor: jaya@fate.edu.np / hed0nist')
  console.log('Teacher: teacher@fate.edu.np / hed0nist')
  console.log('Student: hridaya@fate.edu.np / hed0nist')
}
